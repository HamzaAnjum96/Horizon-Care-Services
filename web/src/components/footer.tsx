  ...
  return (
    <footer className="footer-texture bg-deep border-t border-rule-dark">
      <div className="max-w-4xl mx-auto px-6 lg:px-10 pt-14 pb-8">
        ...
        <p className="text-ink-muted-light text-[14px] leading-relaxed mb-8 max-w-[38ch]">
          Professional health and social care with a calm, personal approach.
        </p>

        <address className="not-italic text-ink-muted-light text-[14px] leading-[1.9]">
        ...
        <div className="border-t border-rule-dark mt-10 pt-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">

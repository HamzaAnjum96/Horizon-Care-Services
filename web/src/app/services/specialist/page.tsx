          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-10">
            ...
            <div className="border-t border-rule-light pt-16 lg:pt-20">
              <div className="grid lg:grid-cols-[2fr_1fr] gap-10 lg:gap-20 items-start">
                <div>
                  <p className="section-kicker text-ink-muted-dark mb-4">Working with us</p>
                  <p
                    className="font-display text-ink-dark leading-tight tracking-[-0.02em] mb-6"
                    style={{
                      fontSize: 'clamp(1.5rem, 2.4vw, 2rem)',
                  ...
                  >
                    We work with NHS teams, local authorities, and families.
                  </p>
                  <p className="text-ink-muted-dark text-[15px] leading-relaxed max-w-[56ch]">
                    If you are a discharge planner, social worker, or family arranging specialist care, we can move quickly. Call us directly for urgent situations. For planned arrangements, get in touch and we will respond within 2 working days.
                  </p>
                </div>

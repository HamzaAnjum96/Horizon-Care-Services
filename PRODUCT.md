...
Authoritative but human. Grounded and direct. No buzzwords, no empty reassurances. The writing should feel like it comes from professionals who have done this for years and care deeply — not from a marketing team. Language is plain, precise, and specific.

Anti-references: NHS.uk (too clinical), generic care agency sites (too soft/amateur), LinkedIn (too corporate). The tone is closer to a specialist architecture or engineering firm that also happens to care deeply about people.
...
- No card grids with icon + heading + text repeated endlessly
- No generic teal-and-white healthcare palette
- No stock photography
- No gradient text
- No hero with a big number metric template
- No side-stripe borders on cards
- No glassmorphism
- No modal forms as the first thought
